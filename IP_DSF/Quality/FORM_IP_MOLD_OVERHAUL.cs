...
namespace IP
{
    public partial class FORM_IP_MOLD_OVERHAUL : Form
    {
        public FORM_IP_MOLD_OVERHAUL()
        {
     ...
     //   bool _IsKey = true;
      //  int icount = 0;
        ...
        private void addUC()
        {
            IP.UC.UC_DWMY ucMenu = new UC.UC_DWMY(5);
        ...
        */
        ...
        private void load_frm()
        {
            try
            {
                ...
                _dt_model = IP.Addons.Database.LOAD_BY_MODEL(viewMode);
                
               // axfpHeaderData.Hide();
                //axGridModel.Hide();

                dt_top = IP.Addons.Database.LOAD_BY_TYPE(viewMode);
        ...
        */
        ...
        #region Event
        private void FORM_IP_MOLD_OVERHAUL_Load(object sender, EventArgs e)
        {
            lblTitle2.Text = "IP Mold Overhaul (" + DateTime.Now.AddDays(-7).ToString("MMM-dd") + " ~ " + DateTime.Now.ToString("MMM-dd") + ")";
            addUC();
            try
            {

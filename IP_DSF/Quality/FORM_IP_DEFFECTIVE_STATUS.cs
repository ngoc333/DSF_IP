...
namespace IP
{
    public partial class FORM_IP_DEFFECTIVE_STATUS: Form
    {
        #region Declare
        int iNumRow = 0;
       ...
       // int _time = 0;
        ...
        #region Creation
        public FORM_IP_DEFFECTIVE_STATUS(int arg_idx = 0)
        {
            InitializeComponent();
            idx_form = arg_idx;
        }
        ...
        private void InitGridHeader()
        {
            ...
            axfpSpread.MaxRows = 50;
            axfpSpread.Font = new System.Drawing.Font("Calibri", 16.00F, System.Drawing.FontStyle.Bold);
            for (int i = 5; i <= 31; i++)
            {
                axfpSpread.Row = -1;
                axfpSpread.Col = i;
            ...
            axfpSpread.Row = -1;
            axfpSpread.Col = axfpSpread.MaxCols;
            axfpSpread.TypeHAlign = TypeHAlignConstants.TypeHAlignRight;
        ...
        private DataTable select_deffect_monitor(string arg_month)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "MES.PKG_SMT_B2_IP.SELECT_DEFFECT_MONITOR_V3";
        ...
        private DataTable select_chart_1(string arg_month)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "MES.PKG_SMT_B2_IP.SELECT_CHART_1_V3";
        ...
        private DataTable select_chart_2(string arg_month)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "MES.PKG_SMT_B2_IP.SELECT_CHART_2_V3";

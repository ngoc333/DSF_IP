...
namespace IP
{
    public partial class FORM_SMT_IP_LEADTIME_MONTH : Form
    {
        public FORM_SMT_IP_LEADTIME_MONTH()
        {
            InitializeComponent();
        ...
        {
            Form fc = Application.OpenForms["FORM_LEADTIME_SYN"];
            if (fc != null)
            {
            ...
            {
                FORM_LEADTIME_SYN f = new FORM_LEADTIME_SYN();
                f.Show();
                this.Hide();
            }
        }

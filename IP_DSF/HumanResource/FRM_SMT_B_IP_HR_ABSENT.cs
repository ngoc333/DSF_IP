...
namespace IP
{
    public partial class FRM_SMT_B_IP_HR_ABSENT : SampleFrm2
    {
        public FRM_SMT_B_IP_HR_ABSENT()
        {
            InitializeComponent();
            tmrTime.Stop();
            tmrLoad.Stop();
      ...
      /*  private void loadDataGridTunover(DataTable argDt)
        ...
        private void loadData()
        {
            try
            {
                System.Data.DataSet ds = GET_DATA("IPP");
        ...
        private void FRM_SMT_HR_ABSENT_Load(object sender, EventArgs e)
        {
            ...
            lblTitle.Text = "IP Human Attendance";

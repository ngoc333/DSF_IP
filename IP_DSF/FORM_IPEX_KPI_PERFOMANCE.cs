...
namespace IP
{
    public partial class FORM_IPEX_KPI_PERFOMANCE : Form
    {
        ...
        public FORM_IPEX_KPI_PERFOMANCE()
        {
            InitializeComponent();
        }
        ...
        private void BindingDataGird()
        {
            ...
            setImage(cmd_C1, axGrid_C1);
            setImage(cmd_C2, axGrid_C2);
            setImage(cmd_C3, axGrid_C3);
            setImage(cmd_C4, axGrid_C4);
            setImage(cmd_C5, axGrid_C5);
            setImage(cmd_C6, axGrid_C6);
